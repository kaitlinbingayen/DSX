...
public class QuoteSide implements Tradable {
    ...
    public QuoteSide (String user, String product, BookSide side, Price price, int originalVolume) throws InvalidValueException, InvalidPriceOperation {
        setUser(user);
        setProduct(product);
        setPrice(price);
    ...
    public String toString(){
        return this.user + " quote side: " + this.side + " " + this.product + " at " + this.price.toString() + ", Orig Vol: " + this.originalVolume +
